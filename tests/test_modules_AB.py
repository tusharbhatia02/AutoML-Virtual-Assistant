...
class TestWakeWord:
    ...
    def test_exact_match(self):
        assert is_wake_word("hey assistant, start training") is True

    def test_variant_hi(self):
        assert is_wake_word("hi assistant") is True
    ...
    def test_fuzzy_typo(self):
        ...
        assert is_wake_word("hey assistants load dataset") is True
